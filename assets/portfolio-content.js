...
(function (root, factory) {
  ...
  const data = {
    ...
    person: {
      ...
      headline: L('실제 업무에 적용할 AI를 설계하고, 평가하고, 배포합니다.', 'I build AI for real work. Then measure what holds up.'),
      intro: L('온프렘 RAG, 에이전트 제품, GPU 기반 업무 자동화. 문제를 정의하는 일부터 답변을 검증하고 서비스로 연결하는 일까지 만듭니다.', 'On-prem RAG, agent products, and GPU-powered workflows. I connect product problems to working systems, evidence-based evaluation, and deployment.'),
      location: L('대한민국 · 한국어 / 영어', 'South Korea · Korean / English')
    },
    projects: [
      {
        id: 'med-rag', number: '01', title: 'MED-RAG',
        subtitle: L('답변이 그럴듯한가보다, 근거에 있는가.', 'From plausible answers to verifiable evidence.'),
        ...
        sections: [
          ...
          { id: 'evaluation', eyebrow: L('03 / EVIDENCE', '03 / EVIDENCE'), title: L('평가를 고치자, 실패 4건이 보였습니다.', 'A better evaluation revealed four failures.'), body: [L('기존 평가자는 실제 검색 문서를 보지 못했습니다. 문서를 전달한 뒤 답변 평가가 24/24에서 20/24로 바뀌었고, 존재하지 않는 인용과 근거 없는 설명을 발견했습니다.', 'The original judge never saw the retrieved documents. Including them changed the answer pass rate from 24/24 to 20/24 and exposed invented quotations and unsupported claims.'), L('검색 성공과 답변 품질을 나눠 평가했습니다. 정답 문서를 찾는 것만으로 근거 있는 답변이 보장되지는 않았습니다.', 'Retrieval and answer quality are measured separately: finding the right document did not guarantee a grounded answer.')], table: { headers: [L('검증 항목', 'Measure'), L('결과', 'Result'), L('조건', 'Conditions')], rows: [
      ...
      },
      {
        ...
        subtitle: L('여러 모델을 하나의 작업 흐름으로.', 'Many models. One accountable workflow.'),
        ...
        sections: [
          { id: 'context', eyebrow: L('01 / PRODUCT', '01 / PRODUCT'), title: L('모델을 바꾸는 일보다 작업을 이어가는 일.', 'Keep the work moving across models.'), body: [L('사용자가 여러 AI 창을 오가며 맥락과 비용을 따로 관리하는 문제에서 시작했습니다. 모델 선호, 연결된 도구, 작업 기록을 한 화면과 하나의 데이터 흐름으로 연결했습니다.', 'The product starts with the friction of switching AI tools while tracking context and cost separately. Model preferences, connected tools, and work history share a single flow.')] },
          { id: 'architecture', eyebrow: L('02 / SYSTEM', '02 / SYSTEM'), title: L('라우팅, 도구, 검토, 기록.', 'Route, act, review, record.'), diagram: [
      ...
      },
      {
        ...
        subtitle: L('회의가 끝나도, 일이 끊기지 않도록.', 'Turn the end of a meeting into the next step.'),
        ...
        sections: [
          { id: 'context', eyebrow: L('01 / WORKFLOW', '01 / WORKFLOW'), title: L('녹음 다음의 반복 작업을 줄이기.', 'Connect the repetitive work after recording.'), body: [L('CLI 도구에서 시작해 웹 UI와 Docker 서비스로 확장했습니다. 녹음 이후의 전사, 발언자 구분, 회의록 작성과 공유를 한 흐름에서 다루도록 만들었습니다.', 'The project grew from a CLI into a web interface and Docker service, bringing transcription, speaker attribution, minutes, and sharing into one workflow.')] },
          { id: 'architecture', eyebrow: L('02 / SYSTEM', '02 / SYSTEM'), title: L('하나의 긴 작업을 관찰 가능한 단계로.', 'One long job, distinct processing stages.'), diagram: [
      ...
      },
      {
        ...
        subtitle: L('복잡한 구조를, 직접 펼쳐 이해하기.', 'Make complex structure explorable.'),
