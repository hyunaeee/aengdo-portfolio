...
const files = ['roles/ai-agent/index.html','roles/ai-agent/en.html','work/visioneye/operations.html','work/visioneye/operations-en.html','history.html','history-en.html','index.html','portfolio.html','en.html','archive.html','archive-en.html','creative.html','creative-en.html', ...data.projects.flatMap(p => [`work/${p.id}/index.html`,`work/${p.id}/en.html`])];
