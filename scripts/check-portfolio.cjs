...
const files = ['index.html','portfolio.html','en.html','archive.html','archive-en.html','creative.html','creative-en.html', ...data.projects.flatMap(p => [`work/${p.id}/index.html`,`work/${p.id}/en.html`])];
